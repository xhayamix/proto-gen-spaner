...
import (
	_ "embed"
	"github.com/xhayamix/proto-gen-spanner/protoc-gen-all/generator/api/output/proto/server/api"
	"sort"
	"strings"
	...
	interactorapi "github.com/xhayamix/proto-gen-spanner/protoc-gen-all/generator/api/output/pkg/cmd/admin/usecase/interactor/api"
	"github.com/xhayamix/proto-gen-spanner/protoc-gen-all/generator/api/output/pkg/cmd/api/middleware/responsecache"
	apiregistry "github.com/xhayamix/proto-gen-spanner/protoc-gen-all/generator/api/output/pkg/cmd/api/registry"
	portapi "github.com/xhayamix/proto-gen-spanner/protoc-gen-all/generator/api/output/pkg/domain/port/api"
	"github.com/xhayamix/proto-gen-spanner/protoc-gen-all/generator/api/output/pkg/infra/genserverapi"
