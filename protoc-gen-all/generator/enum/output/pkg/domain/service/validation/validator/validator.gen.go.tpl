...
import (
	...
	"github.com/xhayamix/proto-gen-spanner/pkg/domain/component/masterdata"
	"github.com/xhayamix/proto-gen-spanner/pkg/domain/entity/master"
	"github.com/xhayamix/proto-gen-spanner/pkg/domain/enum"
	"github.com/xhayamix/proto-gen-spanner/pkg/logging/app"
...
func (v *{{ .CamelName }}Validator) reportTime(sl validator.StructLevel, field string) {
	if _, err := time.ParseInLocation("2006-01-02 15:04:05", field, time.Local); err != nil {
		sl.ReportError(field, master.{{ .PascalName }}ColumnName.Value, master.{{ .PascalName }}ColumnName.Value, "{{ .Name }}", "type$time.Time (2006-01-02 15:04:05)")
	}
}
