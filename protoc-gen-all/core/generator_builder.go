...
import (
	...
	"github.com/xhayamix/proto-gen-spanner/protoc-gen-all/parallel"
...
func (g *generatorBuilder) Generate(generatedFilenamePrefixList []string) error {
	...
	for _, fileNamePrefix := range generatedFilenamePrefixList {
		...
		pathSet.Add(
			...
			// option系
			"pkg/domain/proto/server/master/common/options.pb.go",
			"pkg/domain/proto/server/options/check_option.pb.go",
			"pkg/domain/proto/server/options/zap.pb.go",
			"pkg/domain/proto/server/transaction/common/options.pb.go",
			...
			// pkg/domain/proto/server/api/
			"pkg/domain/proto/server/api/"+fileName+".pb.common_response.gen.go",
			"pkg/domain/proto/server/api/"+fileName+".pb.go",
			"pkg/domain/proto/server/api/"+fileName+".pb.gw.go",
			"pkg/domain/proto/server/api/"+fileName+".pb.validate.go",
			"pkg/domain/proto/server/api/"+fileName+".pb.zap.gen.go",
			"pkg/domain/proto/server/api/"+fileName+"_grpc.pb.go",

			// pkg/domain/proto/server/api/common/
			"pkg/domain/proto/server/api/common/"+fileName+".pb.go",
			"pkg/domain/proto/server/api/common/"+fileName+".pb.validate.go",
			"pkg/domain/proto/server/api/common/"+fileName+".pb.zap.gen.go",

			// pkg/domain/proto/server/common/
			"pkg/domain/proto/server/common/"+fileName+".pb.go",
			"pkg/domain/proto/server/common/"+fileName+".pb.zap.gen.go",

			// pkg/domain/proto/server/enums/
			"pkg/domain/proto/server/enums/"+fileName+".pb.go",

			// pkg/domain/proto/server/exam/
			"pkg/domain/proto/server/exam/"+fileName+".pb.go",
			"pkg/domain/proto/server/exam/"+fileName+"_grpc.pb.go",

			// pkg/domain/proto/server/master/
			"pkg/domain/proto/server/master/"+fileName+".pb.go",

			// pkg/domain/proto/server/transaction/
			"pkg/domain/proto/server/transaction/"+fileName+".pb.go",
			"pkg/domain/proto/server/transaction/"+fileName+".pb.zap.gen.go",
